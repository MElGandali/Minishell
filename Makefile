...
#    Updated: 2023/07/14 01:34:11 by mel-gand         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME = Minishell
CC = gcc
CFLAGS = -I./libf -g -fsanitize=address
...
SRC = minishell.c libf/ft_putstr_fd.c libf/ft_isprint.c libf/ft_strcmp.c libf/ft_atoi.c libf/ft_isalpha.c libf/ft_itoa.c libf/ft_split.c libf/ft_strlen.c libf/ft_substr.c libf/ft_strdup.c  libf/ft_isalnum.c libf/ft_strjoin.c libf/ft_calloc.c  libf/ft_bzero.c \
		...
		parser/fill_newcmd.c parser/print_parser_argument.c parser/check_dollar_expand.c parser/define_data_utils.c parser/expand_data.c parser/fill_define_data.c parser/find_dollar.c \
		...
		executor/handle_cmd.c executor/handle_heredoc.c executor/special_var_heredoc.c executor/find_path.c executor/redirections.c command/unset.c command/env/env_command.c \
