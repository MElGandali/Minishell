...
#    Updated: 2023/05/12 19:40:16 by mel-gand         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = minishell.c libf/ft_strcmp.c libf/ft_split.c libf/ft_strlen.c libf/ft_substr.c libf/ft_strdup.c libf/ft_strjoin.c tokenizer.c \
		check_unclosed_quotes.c tokenizer_error.c split_token.c  split_spaces.c split_spaces_utils.c define_word_token.c 
OBJ = $(SRC:.c=.o)
