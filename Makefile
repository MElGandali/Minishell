...
#    Updated: 2023/05/15 18:46:23 by maddou           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
RM = rm -rf
SRC = minishell.c libf/ft_strcmp.c libf/ft_strlen.c libf/ft_substr.c libf/ft_strdup.c libf/ft_strjoin.c tokenizer.c \
