...
/*   Updated: 2023/07/12 15:38:33 by mel-gand         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	redir_pipe_error_one_arg(t_lexer *lex)
{
	...
	while (lex->word[i])
	{
		if (ft_strcmp(lex->word[i], "|<") == 0 || ft_strnstr(lex->word[i],
				"|>") == 0 || ft_strnstr(lex->word[i], "<|") == 0
			|| ft_strnstr(lex->word[i], "><") == 0 || ft_strnstr(lex->word[i],
				">>|") == 0 || ft_strnstr(lex->word[i], "<<|") == 0
			|| ft_strnstr(lex->word[i], ">>>") == 0 || ft_strnstr(lex->word[i],
				"<>") == 0 || ft_strnstr(lex->word[i], "<<<") == 0
