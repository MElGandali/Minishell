...
/*   Updated: 2023/05/18 23:23:20 by mel-gand         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void count_tokens (t_lexer *lex)
{
    ...
    while(lex->word[i])
    {
        if (check_token(lex, i) == 0)
        {
                ...
                while (lex->word[i][j])
                {
                    if ((lex->word[i][j] == '\'' || lex->word[i][j] == '\"') || (!(lex->word[i][j] == '>' || lex->word[i][j] == '<' || lex->word[i][j] == '|')))
                    {
                         while(!(lex->word[i][j] == '>' || lex->word[i][j] == '<' 
                            || lex->word[i][j] == '|') && lex->word[i][j] != '\0')
                            {
                                ...
                                // || lex->word[i][j] == '\'' || lex->word[i][j] == '\"' )) && lex->word[i][j] != '\0')
                                //     j++;
                            }
                        lex->word_nb++;
                    }
                    if ((lex->word[i][j] == '>' || lex->word[i][j] == '<' || lex->word[i][j] == '|') && lex->word[i][j] != '\0')
                    {
                        while((lex->word[i][j] == '>' || lex->word[i][j] == '<' 
                            || lex->word[i][j] == '|') && lex->word[i][j] != '\0')
                            j++;
